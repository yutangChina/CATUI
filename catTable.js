...
jQuery.fn.catTable = function (obj) {
    ...
    function _handleHeadToVirDom() {
        ...
        var _children = _headVirDom.children[0].children;
        for (var i = 0; i < thead.length; i++) {
            var thText = '';
            if (_thshowType == 'String') {
                thText = thead[i];
            } else {
                thText = thead[i][thField[0]];
                _dataShowOrder.push(thead[i][thField[1]]);
            }
            var _tempTh = {
                tagName: 'th',
                children: [thText]
            ...
            switch (_thStyleType) {
                case 'None':
                    ...
                    break;
                case 'Single':
                    _tempTh['props'] = thStyle[i] == undefined ? {} : thStyle[i];
                    break;
                case 'All':
                    _tempTh['props'] = thStyle;
                    break;
    ...
    function _clickPreviousStep() {
        var dom = document.querySelector('.first-child');
        this[0].addEventListener('click', function (e) {
    ...
    function _clickNextStep() {
        var dom = document.querySelector('.last-child');
        this[0].addEventListener('click', function (e) {
            if (e.target == dom || dom.contains(e.target)) {
                _next();
            }
    ...
    function _changeInputIndexNum() {
        var _inputPage = document.querySelector('.input-page-num');
    ...
    function _changeInputPageNum() {
        document.querySelector('.input-page-num').value = pageNumber + 1;
    }
    /**
